...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("isValidator", make_shared<FunctionType>(strings{"address"}, strings{"bool"}, FunctionType::Kind::IsValidator, true, StateMutability::Pure)),
