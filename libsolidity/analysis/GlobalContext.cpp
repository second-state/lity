...
inline vector<shared_ptr<MagicVariableDeclaration const>> constructMagicVariables()
{
	...
	return {
		...
		magicVarDecl("eni", TypeProvider::function(strings(), strings{"string memory"}, FunctionType::Kind::ENI, FunctionType::SpecialModifier::Default, true, StateMutability::Pure)),
		magicVarDecl("gasleft", TypeProvider::function(strings(), strings{"uint256"}, FunctionType::Kind::GasLeft, false, StateMutability::View)),
		magicVarDecl("isValidator", TypeProvider::function(strings{"address"}, strings{"bool"}, FunctionType::Kind::IsValidator, FunctionType::SpecialModifier::Default, true, StateMutability::Pure)),
		...
		magicVarDecl("rand", TypeProvider::function(strings(), strings{"uint256"}, FunctionType::Kind::Rand, FunctionType::SpecialModifier::Default, true, StateMutability::NonPayable)),
