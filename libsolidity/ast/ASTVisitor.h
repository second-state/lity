...
public:
	...
	virtual bool visit(FireAllRulesStatement& _node) { return visitNode(_node); }
	...
	virtual void endVisit(FireAllRulesStatement& _node) { endVisitNode(_node); }
...
public:
	...
	virtual bool visit(FireAllRulesStatement const& _node) { return visitNode(_node); }
	...
	virtual void endVisit(FireAllRulesStatement const& _node) { endVisitNode(_node); }
