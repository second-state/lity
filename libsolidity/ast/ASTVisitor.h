...
public:
	...
	virtual bool visit(ScheduleStatement& _node) { return visitNode(_node); }
	virtual bool visit(ScheduledOperationStatement& _node) { return visitNode(_node); }
	...
	virtual void endVisit(ScheduleStatement& _node) { endVisitNode(_node); }
	virtual void endVisit(ScheduledOperationStatement& _node) { endVisitNode(_node); }
...
public:
	...
	virtual bool visit(ScheduleStatement const& _node) { return visitNode(_node); }
	virtual bool visit(ScheduledOperationStatement const& _node) { return visitNode(_node); }
	...
	virtual bool visit(Rule const& _node) { return visitNode(_node); }
	virtual bool visit(FactDeclaration const& _node) { return visitNode(_node); }
	virtual bool visit(FieldExpression const& _node) { return visitNode(_node); }
	...
	virtual void endVisit(ScheduleStatement const& _node) { endVisitNode(_node); }
	virtual void endVisit(ScheduledOperationStatement const& _node) { endVisitNode(_node); }
