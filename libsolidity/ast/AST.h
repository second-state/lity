...
public:
	...
	FireAllRulesAnnotation& annotation() const override;
};
...
public:
	...
	void replaceChild(Expression *oldExp, ASTPointer<Expression> newExp) override;

	ASTPointer<Expression> deepCopy() const override
	{
...
public:
	...
	void replaceChild(Expression*, ASTPointer<Expression>) override
	{
