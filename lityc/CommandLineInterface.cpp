...
Allowed options)",
	...
	desc.add_options()
		...
		(
			...
			"Select desired EVM version. Either homestead, tangerineWhistle, spuriousDragon, byzantium, lity (default), constantinople, petersburg (default), istanbul or berlin."
		)
